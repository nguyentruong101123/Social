...
import { navigationMenu } from './SlidebarNavigation';
...
const SideBar = () => {
  ...
  const handleNavigate=(item)=>{
    ...
    if(item.title === "Trang chủ") navigate("/");
    if(item.title === "Tin nhắn") navigate("/message");
  }
...
<div>
        ...
        <div className='pl-5 flex items-center justify-between pt-5'>
          <div className='flex items-center space-x-3'>
            <Avatar src="https://images.fbox.fpt.vn/wordpress-blog/2023/08/tat-ca-thong-tin-ve-luffy.jpg"> </Avatar>
            <div>
